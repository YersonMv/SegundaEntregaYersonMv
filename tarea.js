...
function tienenMismaLongitud(str1, str2) {
    ...
    // De lo contrario, devuelve "false"
    // Tu código:
    if(str1.lengt== str2.lengt) return "true"
    else return "false"
  }
  ...
  const colors = (color)=>{
    ...
    case "green" :
      tColor= "This is green"
      break;
      
    case "orange" :
      tColor= "This is orange"
      break;
  ...
  const devolverPrimerElemento = (array) => {
    ...
    //return array[0] tambien funciona
  ...
  //console.log(verificarPassword(miUsuario,"1123456"))
  ...
  const agregarAmigo = (usuario, nuevoAmigo) => {
    ...
    var user = {
     ...
     usuario.amigos= user.amigos
     usuario.amigos.push(nuevoAmigo)
     return usuario


  }
 // console.log(agregarAmigo(miUsuario,"El yefer"))


 //let miUsuario= nuevoUsuario("armando","armando@sobelo.com","1123456");
 //let miUsuario2= nuevoUsuario("josefa","josefa@sobelo.com","1123456");
 //let miUsuario3= nuevoUsuario("rosita","rosita@sobelo.com","1123456");
 //let user=[miUsuario,miUsuario2,miUsuario3];
 ...
 // console.log(pasarUsuarioAPremium(user))


 const usuarios = [
  {
      name: 'name1',
      email: 'name1@test.test', 
      password: '1234',
      posts: {
          likes: 1
      }
...
//resultado=0
 //let numeros=[1,2,3,"sobelo","con morro"]
// console.log(sumarArray(numeros,resultado))
...
const copiarEach = (array, cb) =>{
  ...
  console.log(copiarEach(numeros, resultado))
